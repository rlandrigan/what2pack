...
$recipeName = filterwords($_POST['recipe_name']);
$recipeCategory = $_POST['tbl_category_id'];
$recipeIngredients = filterwords($_POST['recipe_ingredients']);
$recipeProcedure = filterwords($_POST['recipe_procedure']);
...
if ($uploadOk == 0) {
   $stmt = $conn->prepare("INSERT INTO `tbl_recipe` (`tbl_recipe_id`, `tbl_category_id`, `recipe_name`, `recipe_ingredients`, `recipe_procedure`) VALUES (NULL, :recipeCategory, :recipeName, :recipeIngredients, :recipeProcedure)");
   ...
   window.location.href = 'http://qbranch.scouts13.org/cookbook';
   </script>";
} else {
